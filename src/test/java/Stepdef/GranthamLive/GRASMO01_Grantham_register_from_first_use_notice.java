...
public class GRASMO01_Grantham_register_from_first_use_notice {
	//Initiate driver
	WebDriver driver;	
	...
	@Test(priority=1)
	@Parameters("browser")
	public void i_am_a_user_of_Axate_and_I_am_on_the_registration_page_through_Grantham_FUN(String browser) throws Throwable {
		System.out.println("Executing CRISMO01_Grantham_register_from_first_use_notice");
		...
		if (browser.equalsIgnoreCase("chrome")) { 
			...
			Iliffe_First_Use_Notice iliffe = new Iliffe_First_Use_Notice(driver);
			iliffe.Click_On_Iliffe_First_Use_CreateWallet();
	...
	public void navigated_to_the_same_article() throws Throwable {
	    ...
	    String expected_url = "https://www.granthamjournal.co.uk/news/stowaway-crab-rescued-from-grantham-train-9078953/";
